...
html_theme_options = {
    ...
    "source_repository": "https://github.com/Open-Inflation/fixprice_api",
    "source_branch": "main",
...
_GH_BASE = "https://github.com/Open-Inflation/fixprice_api"
...
jsoncrack_default_options = {
    ...
    "theme": Theme.AUTO,
    "search_policy": SearchPolicy(custom_patterns=['{class_name}.{method_name}.schema.json']),
    "autodoc_ignore": [
    ],
}
